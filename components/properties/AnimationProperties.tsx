...
export function AnimationProperties({ element, onUpdate }: AnimationPropertiesProps) {
    const animation = element.animation || { type: "none", duration: 500, delay: 0 };
        ...
        <div className="space-y-6">
            <div>
                ...
                <Select
                    ...
                    onValueChange={(value: AnimationType) => handleAnimUpdate("type", value)}
                >
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <Input
                        ...
                        onChange={(e) => handleAnimUpdate("duration", Number(e.target.value))}
                        step="100"
                        min="0"
                        className="mt-2"
                    />
