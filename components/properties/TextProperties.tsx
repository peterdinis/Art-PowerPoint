			...
			<div className="grid grid-cols-2 gap-4">
				...
				<div>
					...
					<Input
						...
						onChange={(e) =>
							handleStyleUpdate("lineHeight", Number(e.target.value))
						}
						min="0.5"
						max="3"
						className="mt-2"
			...
			<div className="grid grid-cols-2 gap-2">
				<div className="flex border rounded-md overflow-hidden">
					<Button
						...
						className={cn(
							...
							style.fontWeight === "bold" && "bg-accent",
						)}
						onClick={() =>
							handleStyleUpdate(
								"fontWeight",
					...
					<Button
						...
						className={cn(
							...
							style.fontStyle === "italic" && "bg-accent",
						)}
						onClick={() =>
							handleStyleUpdate(
								"fontStyle",
					...
					<Button
						...
						className={cn(
							"h-8 w-full rounded-none border-l",
							style.textDecoration === "underline" && "bg-accent",
						)}
						onClick={() =>
							handleStyleUpdate(
								"textDecoration",
				...
				<div className="flex border rounded-md overflow-hidden">
					<Button
						...
						className={cn(
							"h-8 w-full rounded-none",
							(!style.textAlign || style.textAlign === "left") && "bg-accent",
						)}
					...
					<Button
						...
						className={cn(
							"h-8 w-full rounded-none border-l",
							style.textAlign === "center" && "bg-accent",
						)}
					...
					<Button
						...
						className={cn(
							"h-8 w-full rounded-none border-l",
							style.textAlign === "right" && "bg-accent",
						)}
