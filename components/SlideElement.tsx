...
export default function SlideElement({ element, isSelected, onSelect, onResize }: SlideElementProps) {
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                style={{
                  ...
                  fontSize: Math.min(element.size.width, element.size.height) * 0.6,
                }}
              >
                ❤️
              </div>
