...
export default function Toolbar() {
  ...
  const handleAddText = (textType: 'heading1' | 'heading2' | 'body' | 'quote' | 'code' = 'body') => {
    const styles: Record<string, { fontSize: number; fontWeight?: string; fontStyle?: string; fontFamily?: string }> = {
    ...
    addElement({
      ...
      size: { width: 400, height: textType === 'heading1' ? 80 : textType === 'heading2' ? 60 : 50 },
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-64">
              ...
              <DropdownMenuItem onClick={() => handleAddText('heading1')} className="gap-3">
                <div className="flex items-center gap-2">
                  <Heading1 className="w-4 h-4" />
                  <span>H1 Nadpis 1</span>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleAddText('heading2')} className="gap-3">
                <div className="flex items-center gap-2">
                  <Heading2 className="w-4 h-4" />
                  <span>H2 Nadpis 2</span>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleAddText('body')} className="gap-3">
                <div className="flex items-center gap-2">
                  <Type className="w-4 h-4" />
                  <span>T Text</span>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleAddText('quote')} className="gap-3">
                <div className="flex items-center gap-2">
                  <Quote className="w-4 h-4" />
                  <span>99 Citát</span>
                </div>
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => handleAddText('code')} className="gap-3">
                <div className="flex items-center gap-2">
              ...
              <DropdownMenuItem onClick={() => handleAddList('unordered')} className="gap-3">
                <List className="w-4 h-4" />
              ...
              <div className="grid grid-cols-2 gap-1 p-2">
                ...
                <DropdownMenuItem onClick={() => handleAddShape('triangle')} className="flex-col gap-2 h-auto py-3">
                  <Triangle className="w-6 h-6" />
                  <span className="text-xs">Trojuholník</span>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleAddShape('rectangle')} className="flex-col gap-2 h-auto py-3">
              ...
              <Dialog open={linkDialogOpen} onOpenChange={setLinkDialogOpen}>
                ...
                <DialogContent>
                  ...
                  <DialogFooter>
                    ...
                    <Button onClick={handleAddLink} disabled={!linkUrl || !linkText}>
                      Pridať
                    </Button>
                  </DialogFooter>
                </DialogContent>
