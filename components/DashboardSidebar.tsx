...
export default function DashboardSidebar() {
  ...
  const handleCreateFromTemplate = () => {
    if (title.trim()) {
      const newId = createPresentation(title.trim(), description.trim() || undefined, selectedTemplateId || undefined);
    ...
    return (
      <div className="flex flex-col h-full">
        <div className="p-6 border-b">
          ...
          <Button onClick={() => { handleCreateNew(); onItemClick?.(); }} className="w-full" size="lg">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <Link
            ...
            className={cn(
              "flex items-center gap-3 px-4 py-3 rounded-lg transition-colors",
              "hover:bg-accent hover:text-accent-foreground",
              isActive('/favorites') ? "bg-accent text-accent-foreground" : "text-foreground"
            )}
          >
          ...
          <Link
            ...
            className={cn(
              "flex items-center gap-3 px-4 py-3 rounded-lg transition-colors",
              "hover:bg-accent hover:text-accent-foreground",
              isActive('/recent') ? "bg-accent text-accent-foreground" : "text-foreground"
            )}
          >
          ...
          <Link
            ...
            className={cn(
              "flex items-center gap-3 px-4 py-3 rounded-lg transition-colors",
              "hover:bg-accent hover:text-accent-foreground",
              isActive('/statistics') ? "bg-accent text-accent-foreground" : "text-foreground"
            )}
          >
        ...
        <div className="p-4 border-t space-y-2">
          <Link
            ...
            className={cn(
              "flex items-center gap-3 px-4 py-3 rounded-lg transition-colors",
              "hover:bg-accent hover:text-accent-foreground",
              isActive('/settings') ? "bg-accent text-accent-foreground" : "text-foreground"
            )}
          >
