...
export default function ChartElement({ element, isSelected }: ChartElementProps) {
    ...
    switch (chartType) {
      case 'bar':
        ...
        chartGroup.selectAll(".bar-label")
          ...
          .attr("x", (_, i) => (xScale(chartData.labels[i]) || 0) + xScale.bandwidth() / 2)
          .attr("y", d => yScale(d) - 5)
      ...
      case 'line':
        const line = d3.line<number>()
          .x((_, i) => (xScale(chartData.labels[i]) || 0) + xScale.bandwidth() / 2)
          .y(d => yScale(d))
        ...
        chartGroup.selectAll("circle")
          ...
          .enter()
          .append("circle")
          .attr("cx", (_, i) => (xScale(chartData.labels[i]) || 0) + xScale.bandwidth() / 2)
          .attr("cy", d => yScale(d))
          .attr("r", 5)
          .attr("fill", "#ffffff")
          .attr("stroke", colorScale(chartData.labels[0]))
        ...
        // Add value labels
        chartGroup.selectAll(".line-label")
          .data(chartData.values)
          .enter()
          .append("text")
      ...
      case 'pie':
        ...
        // Add percentages
        pieGroup.selectAll(".pie-percentage")
          .data(pieData)
          .enter()
          .append("text")
