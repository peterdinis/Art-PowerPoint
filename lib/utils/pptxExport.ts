    ...
    for (const slide of presentation.slides) {
        ...
        if (slide.background) {
            if (slide.background.color) {
                ...
                pptxSlide.background = { fill: slide.background.color.replace("#", "") };
            }
            ...
            switch (el.type) {
                case "text":
                    pptxSlide.addText(el.content, {
                        ...
                        underline: { style: el.style?.textDecoration === "underline" ? "sng" : "none" },
                ...
                case "shape":
                    ...
                    pptxSlide.addShape(shapeType, {
                        ...
                        w,
                        h,
                        fill: { color: el.style?.backgroundColor?.replace("#", "") || "3b82f6" },
                        line: { color: el.style?.borderColor?.replace("#", "") || "000000", width: el.style?.borderWidth || 0 },
                    });
                    break;
            }
        }
