...
export const metadata: Metadata = {
  ...
  description: "Create and manage professional presentations easily and efficiently",
  keywords: ["presentation", "slides", "presentation builder", "presentation creator", "slide maker"],
