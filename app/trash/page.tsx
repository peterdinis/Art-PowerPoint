...
import { ArrowLeft, Trash2, RefreshCcw, XCircle, Calendar, FileText } from "lucide-react";
                    ...
                    <div className="container mx-auto px-4 py-6 lg:py-8 max-w-7xl">
                        <div className="mb-6">
                            ...
                            <p className="text-muted-foreground">
                                Deleted presentations are kept here. You can restore them or delete them permanently.
                            </p>
                        </div>
                                ...
                                <CardContent className="pt-6">
                                    <div className="text-center py-24">
                                        ...
                                        <p className="text-muted-foreground mb-8 max-w-xs mx-auto">
                                            No presentations in the trash. Deleted ones will appear here.
                                        </p>
                                        ...
                                        <CardContent className="pt-0 space-y-4">
                                            <div className="flex flex-col gap-2">
                                                <Button
                                                    ...
                                                    onClick={() => handleRestore(presentation.id, presentation.title)}
                                                >
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => handlePermanentDelete(presentation.id, presentation.title)}
                                                >
